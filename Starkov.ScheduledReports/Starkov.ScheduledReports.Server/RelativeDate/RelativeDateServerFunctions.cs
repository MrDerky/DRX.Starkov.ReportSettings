  ...
  public static class Calculator
  {
    ...
    public static List<RelativeDateCalculator.Calculator.DateOperation> GetDateOperations()
    {
      return new List<DateOperation>() {
        ...
        #region Операции вычисления даты отсчета.
        ...
        new DateOperation("св", "сброс времени", (date) => date.Date),

        #endregion
        
        #region Операции вычисления относительной даты.
        
        new DateOperation("д", "день", (digitPart, date) => date.AddDays(digitPart)),
        new DateOperation("н", "неделя", (digitPart, date) => date.AddDays(digitPart * 7)),
        new DateOperation("м", "месяц", (digitPart, date) => date.AddMonths(digitPart))//,
          //new DateOperation("м", "месяц", (digitPart, date) => date.AddMonth(digitPart))
